    ...
    <div className='pew'>
      ...
      <ul>
        ...
        <div className="head">
            ...
            <h3>First Name: <input type="text" value={firstName} className='pp'/> </h3>
            <h3>Last Name: <input type="text" value={lastName} className='pp'/></h3>
            <h3>Middle Name: <input type="text" value={middleName} className='pp'/></h3>
            <h3></h3>
            <label>
            ...
            <h3>Date of birth :<input type="text" value={dateob} className='pp' /></h3>
            <h3>Phone Number :<input type="text" value={phone} className='pp'/></h3>
            <h3>Email address :<input type="text" value={email}  className='pp'/></h3>
            <h3>Residential Address :<input type="text" value={residentialAddress} className='pp'/></h3>
            <hr />
            <h1>Parent Name:<input type="text" value={paretName}  className='pp'/></h1>
              <h3>Phone Number:<input type="text" value={phone} className='pp'/></h3>
              <h3>Occupation:<input type="text" value={occupation} className='pp'/> </h3>
              <h3>Address:<input type="text"className='pp' value={address} /></h3>
                  <hr />
